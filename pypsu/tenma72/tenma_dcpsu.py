...
class TenmaBase(Serial):
    ...
    .. note:: \* The driver has not been tested on the models with a \*. However, the two
       ...
       with those as well.
        ...
        Manual and specification can be downloaded from here: `https://www.element14.com/community/docs/DOC-75108/l/protocol-information-for-tenma-72-2550-and-tenma-72-2535-qa-window-driver <https://www.element14.com/community/docs/DOC-75108/l/protocol-information-for-tenma-72-2550-and-tenma-72-2535-qa-window-driver>`_
    ...
    def query(self, command, decode_reply=True):
